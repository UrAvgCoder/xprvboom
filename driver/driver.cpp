...
//#define DVR_DEVICE_FILE wxorstr_(L"\\\\.\\ABTRD")// PRIVATE

#define DVR_DEVICE_FILE wxorstr_(L"\\\\.\\ABQDV")// PUBLIC
c_driver::c_driver()
{
/**/
}

//48 8B D9 C7 45 E7 5C 00 44 00 48 8D 4D C7 C7 45
...
NTSTATUS c_driver::read_memory_ex(PVOID64 base, PVOID64 buffer, DWORD size)
{
	copy_memory req = { 0 };
...
NTSTATUS c_driver::write_memory_ex(PVOID64 base, PVOID64 buffer, DWORD size)
{
	copy_memory req = { 0 };
...
PVOID64 c_driver::alloc_memory_ex(DWORD size, DWORD protect)
{
	PVOID64 p_out_address = NULL;
	alloc_memory req = { 0 };
...
NTSTATUS c_driver::free_memory_ex(PVOID64 address)
{
	free_memory req = { 0 };
