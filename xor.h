...
#define Seed2 ((__TIME__[7] - '0') * 1  + (__TIME__[6] - '0') * 10  + \
	(__TIME__[4] - '0') * 60 + (__TIME__[3] - '0') * 600 + \
	(__TIME__[1] - '0') * 3600 + (__TIME__[0] - '0') * 36000)

__forceinline constexpr int LinearCongruentGenerator(int Rounds) {
	return 2013904223 + 2664525 * ((Rounds > 0) ? LinearCongruentGenerator(Rounds - 1) : Seed2 & 0xFFFFFFFF);
}
...
const char XORKEY_A = static_cast<char>(0x24);
const wchar_t XORKEY_W = static_cast<wchar_t>(0x190);
